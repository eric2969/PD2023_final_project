...
void Player::print_table(){
    ...
    BlockRect.setOutlineThickness(unit / 2.f); Side.setOutlineThickness(unit * 2); b_table.setOutlineThickness(unit * 4); Garbage_can.setOutlineThickness(unit * 4); GarRect.setOutlineThickness(unit);
...
void Opponent::print_table(){
    ...
    text.setFont(font);
    RectangleShape BlockRect(Vector2f(unit * 18, unit * 18)), Side(Vector2f(unit * 80, unit * 80)), b_table(Vector2f(unit * width * 20, unit * height * 20));
    BlockRect.setOutlineThickness(unit / 2.f); Side.setOutlineThickness(unit * 2); b_table.setOutlineThickness(unit * 4);
