...
[<img src="https://img.shields.io/badge/Release-v8.7-brightgreen" >](<https://github.com/eric2969/PD2023_final_project/tree/v8.7>)    [<img src="https://img.shields.io/badge/Download-v8.7-red">](<https://github.com/eric2969/PD2023_final_project/archive/refs/tags/v8.7.zip>) <br>
...
## Version History
---
[<img src="https://img.shields.io/badge/Release-v8.7-brightgreen">](#20240124a-v87)<!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[<img src="https://img.shields.io/badge/Beta-v8.6.1beta-blue">](#20240118b-v861beta)-->
- [Version 8](#20240124a-v87) SFML cross-platform
> - [v8.7](#20240124a-v87) Multi Playing mode
...
> - [v5.4](#20231231a-v54beta) Variable table size(only single mode)
> - [v5.3](#20231230b-v532) Add mode choosing in multiplaying
> - [v5.2](#20231229d-v521beta) Complete Game status Transmit, comptete is available
...
---
> ### 2024/01/24.a (v8.7)
> Add mode choosing feature in multiplayer playing <br>
> Socket received timeout is available in Socket.hpp's api

> ### 2024/01/18.c (v8.6.2)
> Validation of Software <br>
> Finish disconnection and dynamic connection checking feature <br>
> Socket Connecting timeout is available in Socket.hpp's api
...
> ### 2023/12/31.b (v6.0beta)
> Add responsive font size based on screen resolution <br>
> Redetermine the range of table size <br>
> Adjustable font feature will be established later

> ### 2023/12/31.a (v5.4beta)
> Add new single player mode: variable table size <br>
> Preparation of RWD based on screen resolution

> ### 2023/12/30.b (v5.3.2)
> Fixed some issue in multiplayer <br>
> Verify beta version

> ### 2023/12/30.a (v5.3.1beta)
> Using identify token in the msg preventing from error <br>
> Create file first if the src file missing

> ### 2023/12/29.e (v5.3beta)
> Add mode choosing in multiplaying <br>
> Enable status display on multi player's title

> ### 2023/12/29.d (v5.2.1beta)
> Add change keyboard fn <br>
> Modify disconnecting mechanism
...
> Connecting fn is waiting to verify
